...
# Spawn Area Config
var spawn_height := 4 # Number of rows above the board
var spawn_width := 4  # Smaller width than the board
var spawn_x_offset := (grid_width - spawn_width) / 2 # Center it
